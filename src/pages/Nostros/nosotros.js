...
export const nosotros = () => {
  return (
    <div className='NosotrosTotal'>
      <div className='nosotros'>
        <div className='quienesSomos'>
          <img src={logo} alt="Logo" className='doggiftLogoNosotros'></img>
          <h2>¿Quiénes somos?</h2>
          <p> En Doggift, somos apasionados por la salud y el bienestar de tus mascotas. 
            ...
            <img src={Tienda} className='tiendaNosotros'></img>
        </div>
          
        <div className='calidadNosotros'>
          <img src={calidad} alt="Logo" className='calidadLogoNosotros'></img>
          <h2>Calidad</h2>
        ...
        <div className='alimentacionSaludNosotros'>
          <img src={salud} alt="Logo" className='alimentacionLogoNosotros'></img>
