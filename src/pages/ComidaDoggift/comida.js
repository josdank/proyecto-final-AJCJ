...
import Ingredientes_naturales from '../../assets/img/2.jpg';
      ...
      <div className="about-container">
        ...
        <section className="natural-ingredients-section">
          <div className="section-content reverse">
            <img src={Ingredientes_naturales} alt="Ingredientes Naturales" />
            <div className="text-content">
        ...
        <section className="cta-section">
          ...
          <button className="cta-button" onClick={handleButtonClick}>Compra Ahora</button>
        </section>
      </div>
  );
};
